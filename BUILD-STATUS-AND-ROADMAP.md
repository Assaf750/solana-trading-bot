...
> **آخر تحديث:** 2026-06-10 · **الحالة على main:** `5da1688` · full suite **1613/1613** · mechanism guard `sources=105 allowlist=1 violations=0` · SSOT drift baseline ثابت · `can_send:true`/`can_broadcast:true` غائبان repo-wide · ALLOWLIST = `Object.freeze(['packages/isolated-signer-runtime/src/'])` · **الطور A مكتمل (Stages 11–13)**.
