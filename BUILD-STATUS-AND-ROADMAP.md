...
> **آخر تحديث:** 2026-06-11 · **الحالة على main:** `015c38b`+ · full suite **1759/1759** · mechanism guard `sources=113 allowlist=1 violations=0` · SSOT drift baseline ثابت · `can_send:true`/`can_broadcast:true` غائبان repo-wide · ALLOWLIST = `Object.freeze(['packages/isolated-signer-runtime/src/'])` · **الطوران A وB مكتملان + بوّابتاهما PASS** · **الطور C جارٍ (Stage 17 ✅ · Stage 18 Operator UI التالي)**.
