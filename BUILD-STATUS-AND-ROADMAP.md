...
> **آخر تحديث:** 2026-06-11 · **الحالة على main:** `288b16d`+ · full suite **1799/1799** · mechanism guard `sources=115 allowlist=1 violations=0` · SSOT drift baseline ثابت · `can_send:true`/`can_broadcast:true` غائبان repo-wide · ALLOWLIST = `Object.freeze(['packages/isolated-signer-runtime/src/'])` · **الطوران A وB مكتملان + بوّابتاهما PASS** · **مرحلتا الطور C (17–18) ✅ — بوّابة الطور C هي التالية**.
