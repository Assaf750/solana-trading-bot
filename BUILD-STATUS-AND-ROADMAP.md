...
> **آخر تحديث:** 2026-06-10 · **الحالة على main:** `cf87dfc` · full suite **1670/1670** · mechanism guard `sources=109 allowlist=1 violations=0` · SSOT drift baseline ثابت · `can_send:true`/`can_broadcast:true` غائبان repo-wide · ALLOWLIST = `Object.freeze(['packages/isolated-signer-runtime/src/'])` · **الطور A مكتمل + بوّابته PASS** (`reports/E2-PHASE-A-GATE-...`) · **الطور B جارٍ (Stage 14 ✅ · Stage 15 ✅ · Stage 16 التالي)**.
