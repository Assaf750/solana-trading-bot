...
| # | Item | Status |
|---|---|---|
| B1 | Custody vendor (KMS/HSM/vault) chosen + minimum controls ratified (§1) | **UNDECIDED** |
| B2 | Deployment boundary defined (isolated process; no API/UI/hot-path key access; no dumps) (§2) | **UNDECIDED** |
| B3 | Dual-control / `signer_control` ops + two-person rule ratified (§3) | **UNDECIDED** |
